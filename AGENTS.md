...
## 🧠 CONTEXT WINDOW MANAGEMENT (SANGAT PENTING)

### Apa itu Context Window?
Context window adalah "memori kerja" Codex dalam satu sesi.
Jika terlalu penuh (80-95%), Codex akan melakukan **automatic compaction**
— meringkas konteks lama agar bisa terus bekerja.

**Risikonya:** Codex bisa lupa detail kecil, nama file, atau instruksi lama.

---

### ✅ ATURAN WAJIB — Update PROJECT_STATUS.md

**Codex WAJIB update `PROJECT_STATUS.md` setelah SETIAP task selesai.**

Yang harus diupdate:
1. Tabel status task (ubah ⏳ → ✅)
2. Daftar file yang dibuat/diubah
3. Status database (migrations, seeders)
4. Error terakhir (jika ada)
5. Langkah berikutnya
6. Riwayat update (tambah baris baru)

```bash
# Commit PROJECT_STATUS.md bersamaan dengan task
git add PROJECT_STATUS.md
git commit -m "chore: update PROJECT_STATUS.md after Task X"
```

---

### 🔄 Jika Context Window Mendekati Penuh (80-95%)

Codex HARUS menjalankan langkah ini **SEBELUM melanjutkan:**

```
1. Baca PROJECT_STATUS.md
2. Update PROJECT_STATUS.md dengan kondisi terkini
3. Commit PROJECT_STATUS.md
4. Lanjutkan task berikutnya berdasarkan PROJECT_STATUS.md
```

---

### 🆘 Jika Codex Kehilangan Arah Setelah Compaction

Jika Codex mulai bingung atau tidak tahu harus mengerjakan apa,
**BACA file-file ini secara berurutan:**

```
1. AGENTS.md          ← Aturan & identitas project (file ini)
2. PROJECT_STATUS.md  ← Kondisi terkini project
3. BLUEPRINT_COMPLETE.md → Detail task yang belum selesai
```

Kemudian lanjutkan dari bagian **"Langkah berikutnya"** di PROJECT_STATUS.md.

---

### 📋 Prioritas Membaca File

Setiap kali sesi baru dimulai, Codex WAJIB membaca file ini berurutan:

```
PRIORITAS 1: AGENTS.md          (file ini — aturan permanen)
PRIORITAS 2: PROJECT_STATUS.md  (kondisi terkini)
PRIORITAS 3: BLUEPRINT_COMPLETE.md (detail task)
```

**Jangan langsung coding tanpa membaca ketiga file di atas!**

---

*AGENTS.md — Dibuat untuk Codex Agent*
*Repository: Exloses/Codex-1*
*Versi: 2.0 (dengan Context Window Management)*
